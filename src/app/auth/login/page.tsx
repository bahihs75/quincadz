...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    e.preventDefault()
    setLoading(true)
    // Note: Supabase session persistence is automatic; 'rememberMe' could be used to set a longer session duration
    // but by default sessions already persist. We include it for UI consistency.
